...
namespace VH_Tools.Models
{
    public class WindowResult
    {
        ...
        public XYZ BetaObstructPoint { get; set; } // Position of the obstruction creating limit Beta
    ...
    public static class Constants
    {
        ...
        public const string P_VLAKVULLING = "vlakvulling";
    ...
    public class DaglichtOptions
    {
        ...
        public bool AllModelOnly { get; set; }
        ...
        public double DefaultFrameHeightMm { get; set; }
        public double DefaultGlassOffsetMm { get; set; }
        public bool FlipAlphaFan { get; set; }
    }
}
